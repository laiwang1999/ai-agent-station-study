...
public class FlowAgentMCPTest {
    ...
    public void test() {
        ...
        OpenAiChatModel chatModel = OpenAiChatModel.builder()
                .openAiApi(OpenAiApi.builder()
                        ...
                        .apiKey("yrwkgKbEjqfKOw85E0KAoSO9hqCVsY8cvX5U554Ii3SShEPH")
    ...
    public McpSyncClient stdioMcpClient_Grafana() {
        Map<String, String> env = new HashMap<>();
        env.put("GRAFANA_URL", "http://192.168.1.108:9200");
        env.put("GRAFANA_API_KEY", "sa-yangjian-c44cc05b-ba52-430c-8872-651d2749331e");
        ...
        var stdioParams = ServerParameters.builder("docker")
                .args("run",
                        ...
                        "-e",
                        "GRAFANA_API_KEY",
                        "registry.cn-hangzhou.aliyuncs.com/xfg-studio/grafana-mcp",
                        "-t",
                        "stdio")
                .env(env)
                .build();
